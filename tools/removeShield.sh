...
Remove_Shield(){
	...
	if [[ $org =~ "Alibaba" ]];then
        ...
        # 屏蔽IP
        setFirewall "close" "ip" "in" "140.205.201.0/28"
        setFirewall "close" "ip" "in" "140.205.201.16/29"
        setFirewall "close" "ip" "in" "140.205.201.32/28"
        setFirewall "close" "ip" "in" "140.205.225.183/32"
        setFirewall "close" "ip" "in" "140.205.225.184/29"
        setFirewall "close" "ip" "in" "140.205.225.192/29"
        setFirewall "close" "ip" "in" "140.205.225.195/32"
        setFirewall "close" "ip" "in" "140.205.225.200/30"
        setFirewall "close" "ip" "in" "140.205.225.204/32"
        setFirewall "close" "ip" "in" "140.205.225.205/32"
        setFirewall "close" "ip" "in" "140.205.225.206/32"
